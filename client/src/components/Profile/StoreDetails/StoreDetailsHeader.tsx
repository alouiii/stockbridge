...
const StoreDetailsHeader: React.FC<StoreDetailsProps> = (props) => {
    ...
    const formattedJoinDate: string = props.joined.toLocaleDateString(undefined, options);

    return (
        <Container className="p-2 m-2" fluid>
            <Row className="align-items-center">
                <Col xs={4}>
                    <Image src={props.image.value} alt={'Store Image'} roundedCircle
                           className={'p-2'}
                           style={{ width: '75%', height: undefined, objectFit: 'cover', aspectRatio:'1/1', cursor: 'pointer' }}
