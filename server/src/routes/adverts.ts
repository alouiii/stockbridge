...
import { deleteAdvert, getAdvert, getAdverts, getAllAdvertsByCategory, postAdvert, putAdvert } from "../controllers/advertController";
...
advertRouter.route('/getAdvertsByCategory/:cat')
