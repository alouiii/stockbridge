...
import {findOrderById, createOrder, updateOrder, delOrder, findAllOrders, findOrderByOffer} from "../services/orderServices";
 ...
 */
export const postOrder = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const putOrder = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    const {id} = req.params;
 ...
 */
export const getOrdersOfOffer = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
