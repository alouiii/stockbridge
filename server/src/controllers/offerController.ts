...
import {findOfferById, createOffer, updateOffer, delOffer, findAllOffers, findAllOffersByAdvert, findAllOffersByOfferor, findAllOffersByOfferee} from "../services/offerServices";
 ...
 */
export const getOffer = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    const {id} = req.params;
 ...
 */
export const getOffers = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const postOffer = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const putOffer = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    const {id} = req.params;
 ...
 */
export const deleteOffer = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    const {id} = req.params;
 ...
 * @returns deleted offer object.
 */
export const getOffersByAdvert = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 * @returns deleted offer object.
 */
export const getOffersByOfferor = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 * @returns deleted offer object.
 */
export const getOffersByOfferee = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
